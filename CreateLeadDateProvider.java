...
import AssignmentWeek5Day1.MyBaseTest;

public class CreateLeadDateProvider extends MyBaseTest {
	@DataProvider(name="TestData")
	public Object[][] fetchData() {
		String[][] data=new String[2][7];
		
		data[0][0]="CTS";
		data[0][1]="Dhilip Sudhan";
		data[0][2]="Muralidharan";
		data[0][3]="QA";
		data[0][4]="Automation Engineer";
		data[0][5]="Quality";
		data[0][6]="1000000";
	...
	public void createLead(String CompName, String  firstName,String lastName, String title, String ProfTitle, String departmentName, String annualRevenue) throws InterruptedException {
		// click Leads
		...
		//Step 18 : Salutation
		driver.findElement(By.name("personalTitle")).sendKeys(title);
